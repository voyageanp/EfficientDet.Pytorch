...
from datasets import CocoBaseOwnDataset, Resizer, Normalizer, Augmenter, collater
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Training dataset
    train_dataset = CocoBaseOwnDataset(
        image_dir='./dataset/fish-school',
        json_file='data.json',
    ...
    model = EfficientDet(num_classes=params.num_class,
